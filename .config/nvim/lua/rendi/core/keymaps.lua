...
keymap.set("n", "<leader>d", '"_d', { desc = "Del motion no copy" })
keymap.set("n", "<leader>dd", '"_dd', { desc = "Del line no copy" })
...
keymap.set("n", "<leader>c", '"_c', { desc = "Change motion no copy" })
keymap.set("n", "<leader>cc", '"_cc', { desc = "Change line no copy" })
